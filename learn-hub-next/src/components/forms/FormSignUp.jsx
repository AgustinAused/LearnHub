    ...
    return (
        <Card color="white" className="p-6 my-36 max-w-screen-lg sm:w-96" shadow={true}>
            ...
            <form className="mt-8 mb-2 w-80 ">
                <div className="mb-4">
                    <Input type="text" name="name" value={formData.name} onChange={handleChange} label="Nombre" />
                </div>
                <div className="mb-4">
                    <Input type="email" name="email" value={formData.email} onChange={handleChange} label="Email" />
                </div>
                <div className="mb-4">
                    <Input type="password" name="password" value={formData.password} onChange={handleChange} label="Contraseña" onKeyUp={handlePasswordChange} />
                    {passwordStrength > 0 && (
                        <div className="text-sm text-red-600 mt-1">
                            Dificultad de la contraseña: {["Muy débil", "Débil", "Razonable", "Fuerte", "Muy fuerte"][passwordStrength - 1]}
                        </div>
                    )}
                ...
                <div className="mb-4">
                    <Input type="celular" name="celular" value={formData.celular} onChange={handleChange} label="Celular" />
                </div>
                <Checkbox
                    label={
                ...
                <Button onClick={handleSubmit} className="mt-6" fullWidth disabled={!isChecked}>
                    Registrarse
                </Button>
